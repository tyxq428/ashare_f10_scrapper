        ...
        "presets": [
            {
                "id": "f10",
                "label": "F10基础数据包",
                "description": "只拉取113个固定接口并生成JSON、Excel、Parquet和DuckDB。",
            ...
            },
            {
                "id": "f10_raw_pack",
                "label": "F10 + Raw Pack",
                "description": "结构化F10加交易所原文、公司官网、IR和权限状态证据。",
            ...
            },
            {
                "id": "f10_official",
                "label": "F10 + 官方交叉验证",
                "description": "F10完成后自动下载免费官方报告并执行字段对账。",
                "include_raw_pack": False,
            ...
            },
            {
                "id": "full_research",
                "label": "完整投研数据包",
                "description": "F10、Raw Pack和官方交叉验证；后两项在F10完成后并行执行。",
                "include_raw_pack": True,
                "run_official_validation": True,
            },
        ],
...
__all__ = ["VisualJobRequest", "manager", "router"]
