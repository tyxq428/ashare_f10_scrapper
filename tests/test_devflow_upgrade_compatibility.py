...
from upgrade_compatibility import preview_state_v2, run_matrix  # noqa: E402
...
def test_upgrade_compatibility_matrix_passes() -> None:
    ...
    assert result["cases"]["descriptor_v1_low_read"]["effective_effort"] == "xhigh"
    assert result["cases"]["descriptor_v2_low_rejected"]["rejected"] is True
